<template>
  <section class="foucs-topic-section">
    ...
    <a :href="linkUrl" class="accent-font link"
      >{{ linkText }}
      <svg
        width="16"
        height="16"
      ...
      >
        ...
        <g mask="url(#mask0_15743_2594)">
          <path
            d="M6.26536 12L5.33203 11.0667L8.3987 8L5.33203 4.93333L6.26536 4L10.2654 8L6.26536 12Z"
            fill="#DD1367"
          />
        </g>
      </svg>
...
onMounted(async () => {
  if (props.item) {
    try {
      const urls = {
        organisation:
          config.public.privateApiUrl + '/organisations/' + props.item,
