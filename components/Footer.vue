      ...
      <div class="content-section-wrapper footer-content">
        ...
        <div class="main-menu" >
          <template v-if="!hideMenu">
            ...
            <MenuMain inFooter :id="'footer-menu-main'"  />
          </template>
        </div>
              ...
              <div class="menu-account">
                <div>
                  <a
                    ...
                    :href="$config.appUrl + '/account?forceRegistration'"
      ...
      <div class="content-section-wrapper">
        <div class="footer-bottom">
          <div class="footer__copyright"
            >{{$t("footerMenuLabels.copyright", {year: year})}}</div>
          <nav class="bottom-menu" id="footer-menu-legal">
            <a :href="$assetURL(paticipactionDeclaration)">{{$t("participationDeclaration")}}</a>
            <NuxtLink
              v-if="$translatePageTitle('imprint')"
              :to="localePath('imprint')"
              >{{ $translatePageTitle("imprint") }}</NuxtLink
            >
            <NuxtLink
              v-if="$translatePageTitle('privacy')"
              :to="localePath('privacy')"
              >{{ $translatePageTitle("privacy") }}</NuxtLink
            >
          </nav>
...
export default {
  ...
  computed: {
    ...
    footerContent() {
      return this.$translateFooterContent(this.$store.state.footerContent);
    },
    year() {
      return new Date().getFullYear();
    },
    participationDeclarationUrl() {
      return this.participationDeclarationUrl;
    },
  },
};
</script>
