<template>
  <a class="card" :href="$config.appUrl + '/organisations/' + organisation.id">
    <div class="logo-column">
      <div class="logo-wrapper">
        <div class="logo">
          <img v-if="logoUrl" class="logo-img" :src="logoUrl" alt="organisation?.name" />
        </div>
      </div>
    </div>
    ...
    <div class="content-column">
      ...
      <div class="infos">
        <div class="description">
          <p class="description-text">{{ excerpt(organisation?.description) }}</p>
        </div>
        <div class="details">
          ...
          <div class="details-entries">
            <div class="content-row">
              <div class="content">
                ...
                <p class="text">
                  <mark>{{ locationString(organisation.location) }}</mark>
                </p>
              </div>
            </div>
            <div class="content-row" v-if="organisation?.impactArea">
              <div class="content">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p class="text">
                  <mark>{{ $t('labels.' + organisation.impactArea) }}</mark>
                </p>
              </div>
            </div>
...
export default {
  ...
  computed: {
    logoUrl() {
      return this.$config.privateAssetsUrl + '/files/' + this.organisation.logo
    }
  },
  methods: {
    excerpt(html, limit = 140) {
      if (!html) {
        return '';
      }
      const ellipsis = '...';
